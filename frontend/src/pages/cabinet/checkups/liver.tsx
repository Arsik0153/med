...
const systemMessage = {
    ...
    content: `
        ...
        Protein metabolism 116.34 - 220.621
        Energy production function 0.713 - 0.992
        Detoxification function 0.202 - 0.991
        Bile secretion 0.432 - 0.826
        Fat content 0.097 - 0.419
